...
class Tarea: #el formato del xml
...
app = Flask(__name__)
cors = CORS(app, resources={r"/*": {"origin": "*"}}) #las protecciones

lista_tareas = ListasTareas()
...
def get_tareas():
    ...
    for tarea in lista_tareas.lista_tareas:
        ...
        #print('Titulo: {} , Fecha: {}'.format(tarea.titulo, tarea.fecha))
...
@app.route('/por_fecha', methods=['GET'])
def get_por_fecha():
